...
export function ScanReceiptDialog({ open, onOpenChange, onClose }: ScanReceiptDialogProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={(v) => { if (!v) { handleReset(); onOpenChange(false); } }}>
      <DialogContentBottomSheet>
        <DialogHeader className="px-6 max-md:px-6 md:px-0 pt-1 md:pt-0">
          ...
          <DialogDescription>Foto struk, transaksi otomatis</DialogDescription>
        </DialogHeader>

        <div className="px-6 max-md:px-6 md:px-0 pb-6">
          {stage === "upload" && (
            <div className="space-y-4">
              ...
              >
                ...
                <div className="text-center">
                  <p className="text-sm font-semibold text-foreground">Ambil Foto atau Pilih Gambar</p>
                  <p className="text-xs text-muted-foreground mt-0.5">Foto struk belanja, nota, atau bukti transaksi</p>
                </div>
              </button>
          ...
          {stage === "scanning" && (
            <div className="space-y-4">
              {imageUrl && (
                <div className="rounded-xl overflow-hidden max-h-48 flex items-center justify-center bg-muted">
                  <img src={imageUrl} alt="Receipt" className="max-h-48 object-contain" />
                </div>
              )}
          ...
          {stage === "preview" && (
            <div className="space-y-4">
              {imageUrl && (
                <div className="rounded-xl overflow-hidden max-h-32 flex items-center justify-center bg-muted relative">
                  <img src={imageUrl} alt="Receipt" className="max-h-32 object-contain" />
                  <button
                    type="button"
                    onClick={handleReset}
